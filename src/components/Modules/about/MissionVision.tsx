        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          >
            ...
            <p className="text-lg leading-relaxed">
              To deliver high-quality knit garments by blending craftsmanship
              with cutting-edge technology, while empowering our workforce and
          ...
          >
            ...
            <p className="text-lg leading-relaxed">
              To be a global leader in sustainable textile manufacturing —
              committed to eco-friendly practices, ethical production, and
              innovation that shapes the future of fashion.
            </p>
          </div>
        </div>
      </div>
